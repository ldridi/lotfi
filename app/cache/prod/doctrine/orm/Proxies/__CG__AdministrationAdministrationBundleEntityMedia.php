 ...
 */
class Media extends \Administration\AdministrationBundle\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Administration\\AdministrationBundle\\Entity\\Media' . "\0" . 'id', '' . "\0" . 'Administration\\AdministrationBundle\\Entity\\Media' . "\0" . 'url', '' . "\0" . 'Administration\\AdministrationBundle\\Entity\\Media' . "\0" . 'alt', '' . "\0" . 'Administration\\AdministrationBundle\\Entity\\Media' . "\0" . 'file', '' . "\0" . 'Administration\\AdministrationBundle\\Entity\\Media' . "\0" . 'tempFilename'];
        }
